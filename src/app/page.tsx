      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-6 -mt-12">
        <div className="max-w-2xl w-full space-y-8 text-center">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl md:text-8xl font-bold tracking-tight bg-gradient-to-r from-white to-gray-900 bg-clip-text text-transparent">
              hi, i'm <span className="font-['Arial',sans-serif] font-normal">@</span>ulacoder
            </h1>
